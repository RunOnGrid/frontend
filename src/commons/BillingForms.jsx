  ...
  return (
    <div className="container-opciones-billing">
      ...
      <div className={selected ? 'opciones-visibles' : 'opciones-no-visibles'}>
        <div onClick={() => seleccionar(op2)} className="billing-options">
          {op2}{' '}
        </div>
        <div onClick={() => seleccionar(op3)} className="billing-options">
          {' '}
          {op3}{' '}
        </div>
        <div onClick={() => seleccionar(op4)} className="billing-options">
          {' '}
          {op4}{' '}
        </div>
        <div
