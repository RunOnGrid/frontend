  ...
  return (
    <div className="menuNavbarLogged">
      <div className="titulos-menuNavbar">
        ...
        <div className="menuNavbar-subtitulo">
          {' '}
      ...
      <div>
        <ul>
          ...
          <Link href="/profile/sharedAccount">
            <li>
              {' '}
              <img className="icono-menuNavbar" src="/group.png" alt="" />{' '}
              Cuenta Compartida{' '}
            </li>
          </Link>
          <Link href=""></Link>
          ...
          <li>
            {' '}
            <img className="icono-menuNavbar" src="/money.png" alt="" /> Gana
            con nosotros
          </li>
          <li>
            {' '}
            <img className="icono-menuNavbar" src="/question.png" alt="" />{' '}
            Obtener ayuda{' '}
          </li>
        </ul>
      </div>
