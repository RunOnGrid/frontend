  ...
  return (
    <div className="pw-reset__container">
      <div className="pw-reset__card">
        ...
        <p className="pw-reset__description">
          Please enter your email address below. We will send you an email with
        ...
        <form>
          <div className="pw-reset__form-group">
            <label className="pw-reset__label" htmlFor="email">
              Email
            </label>
            <input
