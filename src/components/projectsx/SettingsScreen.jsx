  ...
  return (
    <div>
         <div className='notification-screen'>
            ...
            <span >If enabled, Porter will automatically trigger a rollback to the last successful deployment if any services of the new deployment fail to deploy.</span>
