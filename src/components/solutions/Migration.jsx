  ...
  return (
    <div>
      <div
        ...
        <div className="subtituloBanner2">
        ...
        <ItemMigration2
          ...
          subtitle={
            'Get your infrastructure up and running with our expert assistance'
          }
        />
        <ItemMigration3
          number={3}
          ...
          subtitle={
            'Redirect your production traffic to grid only after testing it out'
          }
        />

        <button onClick={() => setPopUp(!popUp)} className="migration-button">
          {' '}
          Start Migrating
        </button>
      </div>
