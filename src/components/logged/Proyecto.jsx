  ...
  return (
    <div>
      ...
      <div className="contenedor-titulos-hosting-click-shared">
        ...
        <span
          className={`spanHosting-clickeable-shared${selected === 3 ? 'focus' : ''}`}
          onClick={() => toggle(3)}>
          {' '}
          Logs
        </span>
        <span
          className={`spanHosting-clickeable-shared${selected === 4 ? 'focus' : ''}`}
          onClick={() => toggle(4)}>
          {' '}
         Storage
        </span>
        <span
          className={`spanHosting-clickeable-shared${selected === 5 ? 'focus' : ''}`}
          onClick={() => toggle(5)}>
          {' '}
          Settings
        </span>
