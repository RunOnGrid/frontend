          ...
          {selected === 0 ? (
            <>
              ...
              <div className="buttons-newComp">
                <div
                  className={database === 'sql' ? 'data-selected' : ''}
                  onClick={() => setDatabase('sql')}>
                  {' '}
                  SQL
                </div>
                <div
                  className={database === 'mongodb' ? 'data-selected' : ''}
                  onClick={() => setDatabase('mongodb')}>
                  {' '}
                  MongoDB
                </div>
                <div
                  className={database === 'mysql' ? 'data-selected' : ''}
