...
const CountrySelector = () => {
    const continents = [
      ...
      const countriesByContinent = {
        '7': ['ALL','Singapore', 'Bahrain', 'United Arab Emirates', 'Hong Kong','Taiwan','Israel','Japan','India','Thailand','Malaysia','Vietnam','Indonesia','South Korea','Philippines','Turkey','China'],
        '2': ['ALL','South Africa'],
        '3': ['ALL','United States', 'Canada', 'Mexico','Panama'],
        '4': ['ALL','Brazil', 'Argentina', 'Chile', 'Paraguay'],
        '5': ['ALL','Finland', 'Bulgaria', 'Germany', 'Poland','France','Portugal','Spain','Slovenia','Sweden','Moldova','Netherlands','Italy','Lithuania','Switzerland','Romania','Estonia','United Kingdom','Russia','Denmark','Hungary','Greece','Norway','Czech Republic','Latvia','Belgium','Serbia','Slovakia','Ireland','Austria','Croatia','Ukraine','Jersey','Iceland','Luxembourg','Cyprus'],
      ...
      const handleAddSelection2 = () => {
        ...
        if (selectedContinent2 === '1' ) {
          // If both "ALL" options are selected, create a special selection
          newSelection = { continent: selectedContinent2, country: selectedCountry2 };
